...
internal sealed class ProductPurchasedEventHandler(IProducts products, ILogger<ProductPurchasedEventHandler> logger)
{
    ...
    [Function(nameof(ProductPurchasedEventHandler))]
    public async Task Run(
        [ServiceBusTrigger("products.productPurchased.v1", Connection = "SERVICE_BUS_CONNECTION_STRING")]
